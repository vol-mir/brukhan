...
const AppLoader = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["ssrRender", _sfc_ssrRender$p]]);
...
const HeaderTop = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["ssrRender", _sfc_ssrRender$o], ["__scopeId", "data-v-4898bd83"]]);
const _sfc_main$o = {
  name: "HeaderTop",
  setup() {
    const getIconPath = (name) => getImagePath("icons", name);
...
const HeaderBottom = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["ssrRender", _sfc_ssrRender$n]]);
const getMenuItems = () => [
  {
    type: "link",
    label: "Home",
...
const MenuItem = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["ssrRender", _sfc_ssrRender$m]]);
const _sfc_main$m = {
  name: "HeaderMainMenu",
  components: {
    MenuItem
...
const HeaderMainMenu = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender$l]]);
const _sfc_main$l = {
...
const HeaderResponsiveBottom = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$k]]);
const _sfc_main$k = {
  name: "MobileMenuItem",
  props: {
    item: {
...
const MobileMenuItem = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["ssrRender", _sfc_ssrRender$j]]);
const _sfc_main$j = {
...
const HeaderMobileMenu = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$i], ["__scopeId", "data-v-e25cde43"]]);
const _sfc_main$i = {
  __name: "AppHeader",
...
const SideOverlay = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$h], ["__scopeId", "data-v-9db8e227"]]);
const _sfc_main$g = {
  name: "AppFooter",
  components: {
    InertiaLink: Link
...
const AppFooter = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$g], ["__scopeId", "data-v-79494728"]]);
const _sfc_main$f = {
  data() {
    return {
      visible: false
...
const ScrollUp = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$f], ["__scopeId", "data-v-068d078c"]]);
const _sfc_main$e = {
  components: {
    InertiaHead: Head,
    AppLoader,
    AppHeader: _sfc_main$i,
    SideOverlay,
    AppFooter,
    ScrollUp
  },
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$e]]);
const _sfc_main$d = {
  name: "InstagramFeed",
  components: {
    Swiper,
...
const InstagramFeed = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$d]]);
const _sfc_main$c = {
  name: "ListServices",
  setup() {
    return {
...
const ListServices = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$c], ["__scopeId", "data-v-0fa1b1fc"]]);
const _sfc_main$b = {
...
const TestimonialReviews = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b], ["__scopeId", "data-v-8676085a"]]);
const _sfc_main$a = {
  name: "AboutUs",
  layout: Layout,
  components: {
...
const AboutUs = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a]]);
...
const Contacts = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9]]);
...
const Faq = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8], ["__scopeId", "data-v-29b49df6"]]);
...
const ListBrands = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$6 = {
  name: "SuperOffer",
  setup() {
    return {
...
const SuperOffer = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$5 = {
  name: "NewProducts",
  setup() {
    return {
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    ...
    id: "arrivals"
  }, _attrs))}><div class="container"><div class="row"><div class="col-md-12 text-center"><div class="section-title"><h2 class="ec-bg-title">New Arrivals</h2><h2 class="ec-title">New Arrivals</h2><p class="sub-title"> Browse The Collection of Top Products </p></div></div></div><div class="row"><div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 ec-product-content" data-aos="flip-left"><div class="ec-product-inner"><div class="ec-pro-image-outer"><div class="ec-pro-image"><a href="#" class="image"><img class="main-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "9_1.jpg"
    )
  )} alt="Product" loading="lazy"><img class="hover-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "9_2.jpg"
    )
  )} alt="Product" loading="lazy"></a><span class="flags"><span class="sale">Sale</span></span><a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "icons",
      "quickview.svg"
    )
  )} class="svg_img pro_svg" alt="" loading="lazy"></a></div></div><div class="ec-pro-content"><h5 class="ec-pro-title"><a href="#">Full Sleeve Cap T-Shirt</a></h5><div class="ec-pro-rating"><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star"></i></div><span class="ec-price"><span class="old-price">$20.00</span><span class="new-price">$15.00</span></span><div class="ec-pro-option"><div class="ec-pro-color"><span class="ec-pro-opt-label">Color</span><ul class="ec-opt-swatch ec-change-img"><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "9_1.jpg"
  ...
  )} data-tooltip="Orange"><span style="${ssrRenderStyle({ "background-color": "#74c7ff" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "9_2.jpg"
  ...
  )} data-tooltip="Green"><span style="${ssrRenderStyle({ "background-color": "#7af6ff" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "9_3.jpg"
  ...
  )} data-tooltip="Sky Blue"><span style="${ssrRenderStyle({ "background-color": "#85ffeb" })}"></span></a></li></ul></div><div class="ec-pro-size"><span class="ec-pro-opt-label">Size</span><ul class="ec-opt-size"><li class="active"><a href="#" class="ec-opt-sz" data-old="$20.00" data-new="$15.00" data-tooltip="Small"> S </a></li><li><a href="#" class="ec-opt-sz" data-old="$22.00" data-new="$17.00" data-tooltip="Medium"> M </a></li><li><a href="#" class="ec-opt-sz" data-old="$25.00" data-new="$20.00" data-tooltip="Large"> X </a></li><li><a href="#" class="ec-opt-sz" data-old="$27.00" data-new="$22.00" data-tooltip="Extra Large"> XL </a></li></ul></div></div></div></div></div><div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 ec-product-content" data-aos="flip-left"><div class="ec-product-inner"><div class="ec-pro-image-outer"><div class="ec-pro-image"><a href="#" class="image"><img class="main-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "11_1.jpg"
    )
  )} alt="Product"><img class="hover-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "11_2.jpg"
    )
  )} alt="Product"></a><span class="flags"><span class="new">New</span></span><a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "icons",
      "quickview.svg"
    )
  )} class="svg_img pro_svg" alt=""></a></div></div><div class="ec-pro-content"><h5 class="ec-pro-title"><a href="#">Classic Leather purse</a></h5><div class="ec-pro-rating"><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star"></i></div><span class="ec-price"><span class="old-price">$100.00</span><span class="new-price">$80.00</span></span><div class="ec-pro-option"><div class="ec-pro-color"><span class="ec-pro-opt-label">Color</span><ul class="ec-opt-swatch ec-change-img"><li class="active"><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "11_1.jpg"
  ...
  )} data-tooltip="Gray"><span style="${ssrRenderStyle({ "background-color": "#dba4ff" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "11_2.jpg"
  ...
  )} data-tooltip="Orange"><span style="${ssrRenderStyle({ "background-color": "#ff4a77" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "11_3.jpg"
  ...
  )} data-tooltip="Green"><span style="${ssrRenderStyle({ "background-color": "#c9ff55" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "11_4.jpg"
  ...
  )} data-tooltip="Sky Blue"><span style="${ssrRenderStyle({ "background-color": "#ffcc5e" })}"></span></a></li></ul></div></div></div></div></div><div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 ec-product-content" data-aos="flip-left"><div class="ec-product-inner"><div class="ec-pro-image-outer"><div class="ec-pro-image"><a href="#" class="image"><img class="main-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "12_1.jpg"
  ...
  )} alt="Product"></a><span class="percentage">5%</span><a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "icons",
      "quickview.svg"
    )
  )} class="svg_img pro_svg" alt=""></a></div></div><div class="ec-pro-content"><h5 class="ec-pro-title"><a href="product-left-sidebar.html"> Fancy Ladies Sandal </a></h5><div class="ec-pro-rating"><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star"></i></div><span class="ec-price"><span class="old-price">$100.00</span><span class="new-price">$80.00</span></span><div class="ec-pro-option"><div class="ec-pro-color"><span class="ec-pro-opt-label">Color</span><ul class="ec-opt-swatch ec-change-img"><li class="active"><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "12_1.jpg"
  ...
  )} data-tooltip="Gray"><span style="${ssrRenderStyle({ "background-color": "#db9dff" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "12_2.jpg"
  ...
  )} data-tooltip="Orange"><span style="${ssrRenderStyle({ "background-color": "#00ffff" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "12_3.jpg"
  ...
  )} data-tooltip="Green"><span style="${ssrRenderStyle({ "background-color": "#ffa7f3" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "12_4.jpg"
  ...
  )} data-tooltip="Sky Blue"><span style="${ssrRenderStyle({ "background-color": "#89ff7e" })}"></span></a></li></ul></div><div class="ec-pro-size"><span class="ec-pro-opt-label">Size</span><ul class="ec-opt-size"><li class="active"><a href="#" class="ec-opt-sz" data-old="$50.00" data-new="$40.00" data-tooltip="Small"> 6 </a></li><li><a href="#" class="ec-opt-sz" data-old="$60.00" data-new="$50.00" data-tooltip="Medium"> 7 </a></li><li><a href="#" class="ec-opt-sz" data-old="$70.00" data-new="$60.00" data-tooltip="Large"> 8 </a></li><li><a href="#" class="ec-opt-sz" data-old="$80.00" data-new="$70.00" data-tooltip="Extra Large"> 9 </a></li></ul></div></div></div></div></div><div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 ec-product-content" data-aos="flip-left"><div class="ec-product-inner"><div class="ec-pro-image-outer"><div class="ec-pro-image"><a href="#" class="image"><img class="main-image"${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "product-image",
      "13_1.jpg"
  ...
  )} alt="Product"></a><a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img${ssrRenderAttr(
    "src",
    $setup.getImagePath(
      "icons",
      "quickview.svg"
    )
  )} class="svg_img pro_svg" alt=""></a></div></div><div class="ec-pro-content"><h5 class="ec-pro-title"><a href="#">Womens Leather Backpack</a></h5><div class="ec-pro-rating"><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star fill"></i><i class="ecicon eci-star"></i></div><span class="ec-price"><span class="old-price">$100.00</span><span class="new-price">$80.00</span></span><div class="ec-pro-option"><div class="ec-pro-color"><span class="ec-pro-opt-label">Color</span><ul class="ec-opt-swatch ec-change-img"><li class="active"><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "13_1.jpg"
  ...
  )} data-tooltip="Gray"><span style="${ssrRenderStyle({ "background-color": "#deffa4" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "13_2.jpg"
  ...
  )} data-tooltip="Orange"><span style="${ssrRenderStyle({ "background-color": "#ffcdbe" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "13_3.jpg"
  ...
  )} data-tooltip="Green"><span style="${ssrRenderStyle({ "background-color": "#ff94df" })}"></span></a></li><li><a href="#" class="ec-opt-clr-img"${ssrRenderAttr(
    "data-src",
    $setup.getImagePath(
      "product-image",
      "13_4.jpg"
  ...
  )} data-tooltip="Sky Blue"><span style="${ssrRenderStyle({ "background-color": "#dd9bfc" })}"></span></a></li></ul></div></div></div></div></div><div class="col-sm-12 shop-all-btn"><a href="#">Shop All Collection</a></div></div></div></section>`);
}
...
const NewProducts = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$4 = {
  name: "TwoBanners",
  setup() {
    return {
...
const TwoBanners = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$3 = {
  name: "HomePage",
  layout: Layout,
  components: {
